...
//pEffect->SetMatrix("oblv_WorldInverse_MAINPASS", &Constants.wrld_inv);
  ...
  pEffect->SetMatrix("oblv_PreviousViewProjectionTransform_MAINPASS", &Constants.lastviewproj);
  ...
  pEffect->SetMatrix("oblv_PreviousWorldViewProjectionTransform_MAINPASS", &Constants.lastwrldviewproj);
